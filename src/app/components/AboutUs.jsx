export default function AboutUs() {
  const ingredients = [
    ...
    "uthentic Wood-Fired Oven: Every pizza benefits from the smoky aroma and crisp perfection achieved in our traditional wood-fired oven. This age-old method, cherished in Italy, brings out the soul of every ingredient."
  ];
